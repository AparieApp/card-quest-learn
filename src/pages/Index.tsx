        ...
        <section className="py-8 px-4">
          <div className="container mx-auto text-center">
            ...
            <h1 className="text-3xl font-bold mb-4">
              Welcome to <span className="text-flashcard-primary">Aparie</span>
            </h1>
            
            <div className="space-y-8 mt-8">
              <div className="bg-flashcard-primary/10 rounded-lg p-4">
                <BookOpen className="w-8 h-8 text-flashcard-primary mx-auto mb-2" />
                <h3 className="text-lg font-semibold">Create Flashcards</h3>
                <p className="text-sm text-muted-foreground">
                  Create custom decks for any subject you want to learn
                </p>
              </div>
              
              <div className="bg-flashcard-primary/10 rounded-lg p-4">
                <Brain className="w-8 h-8 text-flashcard-primary mx-auto mb-2" />
                <h3 className="text-lg font-semibold">Practice & Test</h3>
                <p className="text-sm text-muted-foreground">
                  Study with different modes to improve retention
                </p>
              </div>
              
              <div className="bg-flashcard-primary/10 rounded-lg p-4">
                <Share2 className="w-8 h-8 text-flashcard-primary mx-auto mb-2" />
                <h3 className="text-lg font-semibold">Share Your Knowledge</h3>
                <p className="text-sm text-muted-foreground">
                  Easily share decks with friends and classmates
                </p>
              </div>
            </div>
