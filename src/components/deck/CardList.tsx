...
const CardList: React.FC<CardListProps> = ({ 
  ...
  return (
    <div className="space-y-4">
      {cards.map((card) => {
        // Ensure manual_incorrect_answers is always an array
        const manualIncorrectAnswers = Array.isArray(card.manual_incorrect_answers) 
          ? card.manual_incorrect_answers 
          : [];
          
        console.log(`Card ${card.id} has ${manualIncorrectAnswers.length} manual incorrect answers:`, manualIncorrectAnswers);
